...
public final class TelegramVoiceClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // Video playback is tick-driven and independent from the Plasmo Voice audio engine.
        ClientTickEvents.END_CLIENT_TICK.register(client -> VideoNotePlaybackManager.getInstance().tick(50));
